        ...
        <main className="min-h-screen bg-slate-950 text-white p-4 md:p-8 space-y-8">
            ...
            <div className="flex items-center justify-between max-w-6xl mx-auto">
                <div className="flex items-center gap-4">
                    <Link href="/FantasyQuizzesKingdom/admin">
                ...
                <Button variant="ghost" onClick={async () => { await logout(); router.push("/FantasyQuizzesKingdom/admin"); }} className="text-white/40 hover:text-red-400">
